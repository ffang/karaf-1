...
public class XATest extends KarafTestSupport {
    ...
    public void test() throws Exception {
        ...
        System.out.println(" ");
        System.out.println(executeCommand("jms:info artemis", new RolePrincipal("admin")));
        ...
        System.out.println(" ");
        System.out.println(executeCommand("jdbc:ds-list", new RolePrincipal("admin")));
        ...
        System.out.println(executeCommand("jdbc:execute derby CREATE TABLE messages (id INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY, message VARCHAR(1024) NOT NULL, CONSTRAINT primary_key PRIMARY KEY (id))", new RolePrincipal("admin")));
        ...
        System.out.println(executeCommand("jms:send artemis MyQueue 'the-message'", new RolePrincipal("admin")));
